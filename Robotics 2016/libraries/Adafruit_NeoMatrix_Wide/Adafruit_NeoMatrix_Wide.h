...
#ifndef _ADAFRUIT_NEOMATRIX_WIDE_H_
#define _ADAFRUIT_NEOMATRIX_WIDE_H_
...
class Adafruit_NeoMatrix_Wide : public Adafruit_GFX_Wide, public Adafruit_NeoPixel {

 public:

  // Constructor for single matrix:
  Adafruit_NeoMatrix_Wide(int w, int h, uint8_t pin = 6,
    uint8_t matrixType = NEO_MATRIX_TOP + NEO_MATRIX_LEFT + NEO_MATRIX_ROWS,
    uint8_t ledType    = NEO_GRB + NEO_KHZ800);

  // Constructor for tiled matrices:
  Adafruit_NeoMatrix_Wide(uint8_t matrixW, uint8_t matrixH, uint8_t tX,
